...
const WHATSAPP = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "+2349064957884";
const WA_URL = `https://wa.me/${WHATSAPP.replace(/[^0-9]/g, "")}`;

export function DemoSection() {
  return (
    <section id="demo" aria-labelledby="demo-heading" className="bg-gradient-to-br from-deep-navy to-clinical-teal py-20 lg:py-24 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10">
          <h2 id="demo-heading" className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white mb-3">
